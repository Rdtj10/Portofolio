        ...
        {projects?.map(
          (
            ...
            >
              ...
              <h1 className="absolute -top-6 left-0 text-9xl font-extrabold dark:text-white text-yellow-600 transition-all duration-300 group-hover:-translate-y-10 opacity-0 group-hover:opacity-100">0{index + 1}</h1>
                ...
                Build with : <Icon icon="devicon:nextjs" /> <Icon icon="skill-icons:golang" />
                </h1>
