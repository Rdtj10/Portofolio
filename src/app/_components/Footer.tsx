...
const Footer = () => {
  return (
    <footer className="w-full pt-16 md:pt-32 pb-12 md:pb-16 px-6 lg:px-24 bg-background relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto flex flex-col gap-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-12 xl:col-span-7 flex flex-col gap-8 text-center xl:text-left">
            <div className="flex flex-col gap-2">
              <h3 className="text-2xl md:text-5xl font-black tracking-tighter font-serif leading-none">
                Ridho Dimas<span className="text-primary italic">.</span>
              </h3>
              <p className="text-[10px] md:text-xs text-foreground/30 font-black uppercase tracking-[0.4em] italic leading-relaxed">
                A Weaver of Digital Meadows & Architect of Serene Experiences.
              </p>
            </div>

            <p className="text-lg md:text-2xl text-foreground/50 leading-relaxed font-serif italic max-w-2xl mx-auto xl:mx-0 pr-0 xl:pr-12">
            ...
            <div className="flex items-center gap-6">
              {[
                ...
                <a
                  ...
                  className="w-12 h-12 md:w-16 md:h-16 bg-white/40 border border-white/60 rounded-[1.2rem] flex items-center justify-center text-foreground/40 hover:text-primary hover:bg-white hover:scale-110 active:scale-95 transition-all shadow-sm group relative"
                  title={link.label}
                >
                  <Icon
                    icon={link.icon}
        ...
        {/* Bottom Bar */}
        <div className="pt-10 border-t border-border/30 flex flex-col md:flex-row justify-between items-center gap-8 text-center md:text-left">
          <div className="flex items-center gap-4 text-foreground/30 justify-center md:justify-start">
            <Icon icon="lucide:feather" className="text-2xl animate-float shrink-0" />
